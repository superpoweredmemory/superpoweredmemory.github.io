...
Learning is a crucial part of our lives.
...
Our first step in the quest to become effective learners is to understand what Elizabeth and Robert Bjork call the “important peculiarities” of human memory. We need to know the way our memories store and retrieve new knowledge so that we can tailor our learning approach to one that enhances those processes.
